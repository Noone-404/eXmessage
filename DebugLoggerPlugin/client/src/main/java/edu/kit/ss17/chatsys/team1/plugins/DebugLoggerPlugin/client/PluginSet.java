...
public class PluginSet implements PluginSetInterface {
	...
	private static final String NAME    = "Debug Logger - Client";
	private static final String DESC    = "Provides various debugging features.";
	...
	public PluginSet() {
		...
		GuiMenuPlugin guiMenuPlugin     = new GuiMenuPlugin(this, dataElementPlugin, documentPlugin);
		ByteTestSP    byteTestPlugin    = new ByteTestSP(this, guiMenuPlugin);

		this.plugins = Arrays.asList(dataElementPlugin, documentPlugin, guiMenuPlugin, byteTestPlugin);
